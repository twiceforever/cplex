...
public:
    ...
    IloOplDataFileReaderI(IloEnvI* env, std::istream& ins, const char* name);
...
public:
    ...
    virtual void printExtractable(const IloExtractable& extractable, std::ostream& serializer) =0;
};
...
private:
    ...
    std::ostream& newline(IloInt  pos);
    std::ostream& item();
    std::ostream& prefix();
    std::ostream& open();
    std::ostream& close();
...
public:
    IloOplDataSerializerI(IloEnvI* env, std::ostream& os, const char* title =0);
    IloOplDataSerializerI(IloEnvI* env, const IloOplSettingsI& settings, std::ostream& os, const char* title =0);
    IloOplDataSerializerI(IloEnvI* env, std::ostream* os, IloInt defaultPrecision =4);
    ...
    static void PrintString(std::ostream& os, const char* text, IloBool raw, IloBool escaped);
    static void PrintNum(std::ostream& os, IloNum value, IloInt precision =-1);
    static void PrintNumRange(std::ostream& os, IloNum lb, IloNum ub, IloInt precision =-1);

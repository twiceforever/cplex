...
public:
    ...
    IloOplDataSource(IloEnv env, std::istream& ins, const char* name):_impl(0) {
...
public:
    ...
    ILO_OPL_DEPRECATED
    IloOplDataHandler(IloEnv env, IloOplSettings settings, std::ostream& outs);

    
    ILO_OPL_DEPRECATED
    IloOplDataHandler(IloEnv env, std::ostream& outs);
...
public:
    ...
    IloOplDataSerializer(IloEnv env, IloOplSettings settings, std::ostream& outs);

    
    IloOplDataSerializer(IloEnv env, IloOplSettings settings, std::ostream& outs, IloBool header);

    
    IloOplDataSerializer(IloEnv env, IloOplSettings settings, std::ostream& outs, const char* title);

    
    IloOplDataSerializer(IloEnv env, std::ostream& outs);

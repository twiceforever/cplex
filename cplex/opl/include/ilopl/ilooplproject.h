...
public:
    ...
    IloOplProject(IloEnv env, std::istream* ins, const char* name):_impl(0) {
    ...
    static void ApplyProjectSettings(std::istream& opsStream, const char* name, IloOplModel model) {
        IloOplProjectI::ApplyProjectSettings(opsStream,name,model.impl());
    }

    
    static void ReadProjectSettings(std::istream& opsStream, const char* name, IloCplex cplex, IloCplex::ParameterSet parameterSet, IloOplSettings settings) {
        IloOplProjectI::ReadProjectSettings(opsStream,name,*cplex.getImpl(),parameterSet,settings.impl());
    }
    
    static void WriteProjectSettings(IloCplex cplex, IloCplex::ParameterSet parameterSet, std::ostream& opsStream, const char* name) {

...
public:
	...
	IloTupleCellsHashBase(IloMemoryManagerI* env,
		IloHashFunction hashFct,
		IloCompFunction compFct,
		IloInt size=IloDefaultHashSize)
...
public:
	...
	IloTupleCells2IndexHash(IloMemoryManagerI* env, IloTupleCellsHashFunction hashFct, IloTupleCellsCompFunction compFct, IloInt size = IloDefaultHashSize)
...
public:
	...
	typedef IloBool (*IloCompFunction) (IloInt, IloInt);
		...
		IloHashFunction hashFct = IloIntDataTableHashFunction,
		IloCompFunction compFct = IloIntDataTableCompFunction,
		IloInt size=IloDefaultHashSize)

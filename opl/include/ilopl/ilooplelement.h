...
inline
IloDiscreteDataCollection IloOplElement::asDiscreteDataCollection() const {
    return impl().asDiscreteDataCollection();
}
inline
...
inline
IloBool IloOplElement::isMap() const {
    return impl().isMap();
}
inline
IloBool IloOplElement::isDiscreteDataCollection() const {
    return impl().isDiscreteDataCollection();
}

...
public:
	...
	void buildIntCaches(IloCacheGenAlloc*);
	void buildNumCaches(IloCacheGenAlloc*);
	void buildAnyCaches(IloCacheGenAlloc*);
	void buildCommonCaches(IloCacheGenAlloc*);

	void buildCache(IloCacheGenAlloc*);
private:
...
public:
	...
	IloTuplePath* getFirst() { return _list[0]; }

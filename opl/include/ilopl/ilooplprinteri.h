...
//#define ILOCOUNTDIFFERENT_ACTIV
...
class IloEvaluableIntCollectionSlotInTuple;
class IloEvaluableNumMapSlotInTuple;
class IloEvaluableNumCollectionSlotInTuple;
...
class IloStrongCollectedMapI;
class IloStrongExprArrayI;
class IloInverseCollectedMapI;
class IloCountCollectedMapI;
class IloCountDiffCollectedMapI;
...
class IloIntQuadExprI;
class IloNumQuadExprI;
...
public:
	...
	void print(std::ostream& os, const IloExtractableI* extr);
	void printOther(std::ostream& os, const IloRttiEnvObjectI* obj);
	void printOther(std::ostream& os, const IloOplObject& item);

    void printName(std::ostream& os, const IloExtractableI* extr);
...
private:
    ...
    typedef IloAddressHashTable<IloConstraintArray> ExpandedForAllCache;
...
public:
    ...
    void printIloStrongCollectedMapI(const IloStrongCollectedMapI* e);
    void printIloStrongExprArrayI(const IloStrongExprArrayI* e);
...
#ifdef ILOCOUNTDIFFERENT_ACTIV
    void printIloCountDiffCollectedMapI(const IloCountDiffCollectedMapI* e);
#endif
    ...
    void printIloIntQuadExprI(const IloIntQuadExprI* e);
    void printIloNumQuadExprI(const IloNumQuadExprI* e);
	...
	void printIloAtoiI(const IloAtoiI* e);
	void printIloItoaI(const IloItoaI* e);
...
//    void printIloNumMapParamI(const IloNumMapParamI* e);
	...
	void printIloAdvSameSequenceI( const IloAdvSameSequenceI *e );

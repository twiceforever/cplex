...
class ILOOPL_EXPORTED IloOplModelI : public IloDestroyableI {
  ...
  IloOplRunseedProgressI* _runseedProgress;
  ...
  void registerRunseedProgressListener(IloOplRunseedProgressI* d);
  void unregisterRunseedProgressListener(IloOplRunseedProgressI* d);
...
public:
    ...
    void clear();
    void deleteStart(IloCplexI* cplex);

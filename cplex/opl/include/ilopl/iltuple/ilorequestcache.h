...
protected:
	IloIntArray _empty;
	IloCacheGenAlloc* _stack;
public:
	
	IloTupleRequestCacheI(IloEnv env, IloCacheGenAlloc* stack);
	virtual ~IloTupleRequestCacheI();
	
	virtual IloIntArrayI* execute()=0;
	
	virtual IloBool store(IloIntArrayI* slice)=0;
	IloCacheGenAlloc* getStack(){ return _stack; }
};
...
public:
	...
	IloTupleRequestUnaryCacheI(IloEnv env, IloCacheGenAlloc* stack);
...
public:
	...
	IloNaryIntCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt keySize, IloInt** key, IloMultipleIntHashTable* h);
...
public:
	...
	IloSimplifiedNaryIntCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt size, IloInt** key, IloMultipleIntHashTable* h);
...
public:
	...
	IloNaryIntUnaryCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt keySize, IloInt** key, IloMultipleUnaryIntHashTable* h);
...
public:
	...
	IloSimplifiedNaryIntUnaryCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt size, IloInt** key, IloMultipleUnaryIntHashTable* h);
...
public:
	...
	IloNaryNumCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt keySize, IloNum** key, IloMultipleNumHashTable* h);
...
public:
	...
	IloSimplifiedNaryNumCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt size, IloNum** key, IloMultipleNumHashTable* h);
...
public:
	...
	IloNaryNumUnaryCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt keySize, IloNum** key, IloMultipleUnaryNumHashTable* h);
...
public:
	...
	IloSimplifiedNaryNumUnaryCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt size, IloNum** key, IloMultipleUnaryNumHashTable* h);
...
public:
	...
	IloNaryAnyCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt keySize, IloAny** key, IloMultipleAnyHashTable* h);
...
public:
	...
	IloSimplifiedNaryAnyCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt size, IloAny** key, IloMultipleAnyHashTable* h);
...
public:
	IloNaryAnyUnaryCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt keySize, IloAny** key, IloMultipleUnaryAnyHashTable* h);
...
private:
	...
	IloMultipleUnaryAnyHashTable* _hash;
public:
	IloSimplifiedNaryAnyUnaryCacheI(IloEnv env, IloCacheGenAlloc* stack, IloInt size, IloAny** key, IloMultipleUnaryAnyHashTable* h);
...
public:
	...
	IloNaryCellCacheI(IloEnv env, IloCacheGenAlloc* stack, IloTupleRequestI* key, IloQueryDataTableHash* h);
...
public:
	...
	IloNaryCellUnaryCacheI(IloEnv env, IloCacheGenAlloc* stack, IloTupleRequestI* key, IloQueryUnaryDataTableHash* h);
